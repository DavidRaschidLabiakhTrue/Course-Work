...
int main(int argc, char **argv) {
    ...
    char* format_str = const_cast<char*>("");
    int add_img;
    ...
    if(!_stricmp(argv[1],"-p"))
        ...
        format_str = const_cast<char*>("../positive/positive%04d.pgm");
        add_img = 2000;
    ...
    else if(!_stricmp(argv[1],"-pa"))
    {
        ...
        format_str = const_cast<char*>("../48x48/andy_pos/scface%05d.pgm");
        add_img = 0;
        start_scale = 1.6;
        end_scale = 2.8;
        num_imgs = 2429;
    ...
    else if(!_stricmp(argv[1],"-na"))
    {
        ...
        format_str = const_cast<char*>("../48x48/andy_neg/*.pgm");
        path = const_cast<char*>("../48x48/andy_neg/");
        add_img = 0;
        start_scale = 1.8;
        end_scale = 2.6;
        num_imgs = 5000;
    ...
    else if(!_stricmp(argv[1],"-pbf"))
    {
        ...
        format_str = const_cast<char*>("../48x48/baris_front/*.pgm");
        path = const_cast<char*>("../48x48/baris_front/");
        add_img = 0;
        start_scale = 1.8;
        end_scale = 2.6;
        num_imgs = 5000;
    ...
    else if(!_stricmp(argv[1],"-pbm"))
    {
        ...
        format_str = const_cast<char*>("../48x48/baris_mid/*.pgm");
        path = const_cast<char*>("../48x48/baris_mid/");
        add_img = 0;
        start_scale = 1.8;
        end_scale = 2.6;
        num_imgs = 5000;
    ...
    else if(!_stricmp(argv[1],"-pw"))
    {
        ...
        format_str = const_cast<char*>("../48x48/west/*.pgm");
        path = const_cast<char*>("../48x48/west/");
        add_img = 0;
        start_scale = 1.8;
        end_scale = 2.6;
        num_imgs = 5000;
	...
	else if(!_stricmp(argv[1],"-po"))
	{
		...
		format_str = const_cast<char*>("../48x48/original/*.pgm");
		path = const_cast<char*>("../48x48/original/");
		add_img = 0;
		start_scale = 3.0;
		end_scale = 4.6;
		num_imgs = 5000;
	...
	else if(!_stricmp(argv[1],"-pc"))
	{
		...
		format_str = const_cast<char*>("../48x48/crop/*.pgm");
		path = const_cast<char*>("../48x48/crop/");
		add_img = 0;
		start_scale = 2.0;
		end_scale = 6.0;
		num_imgs = 5000;
    ...
    else if(!_stricmp(argv[1],"-n0"))
    {
        ...
        format_str = const_cast<char*>("../48x48/01-1m/*.pgm");
        path = const_cast<char*>("../48x48/01-1m/");
        add_img = 0;
        start_scale = 1.8;
        end_scale = 2.6;
        num_imgs = 5000;
    ...
    else if(!_stricmp(argv[1],"-ns"))
    {
        ...
        format_str = const_cast<char*>("../48x48/squirrel_pos/*.pgm");
        path = const_cast<char*>("../48x48/squirrel_pos/");
        add_img = 0;
        start_scale = 1.8;
        end_scale = 2.6;
        num_imgs = 5000;
    ...
    else if(!_stricmp(argv[1],"-no"))
    {
        ...
        format_str = const_cast<char*>("../48x48/original_non/*.pgm");
        path = const_cast<char*>("../48x48/original_non/");
        add_img = 0;
        start_scale = 1.8;
        end_scale = 2.6;
        num_imgs = 5000;
        ...
        format_str = const_cast<char*>("../scenery/scenery%05d.pgm");
        add_img = 12000;
        eat_whole_directory = 0;
        }
	...
	if(strstr(argv[2],".txt"))
		{
		classifiers = read_text_classifiers(const_cast<char*>("new.txt"),mask_height,mask_width);
		}
	else
		{
    ...
    if(single_img==1)
		...
		write_image(scale_image, const_cast<char*>("scale.pgm"),0);
        ...
        write_image(out_image, const_cast<char*>("detected.pgm"),0);
